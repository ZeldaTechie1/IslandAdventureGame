...
//////////////////////////////////////////////////////////////////////////
// AIslandAdventureGameCharacter

AIslandAdventureGameCharacter::AIslandAdventureGameCharacter(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer.SetDefaultSubobjectClass<UPlayerMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	MovementComponent = Cast<UPlayerMovementComponent>(GetCharacterMovement());
...
void AIslandAdventureGameCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AIslandAdventureGameCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AIslandAdventureGameCharacter::Move);
...
void AIslandAdventureGameCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AIslandAdventureGameCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AIslandAdventureGameCharacter::Climb()
{
	MovementComponent->TryClimbing();
}

void AIslandAdventureGameCharacter::CancelClimb()
{
	MovementComponent->CancelClimbing();
}

void AIslandAdventureGameCharacter::ClimbDash()
{
